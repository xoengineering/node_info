...
RSpec.describe NodeInfo::Client do
  ...
  describe '#discover' do
    ...
    it 'raises DiscoveryError on HTTP error' do
      ...
      expect { client.discover(domain) }
        .to raise_error NodeInfo::DiscoveryError, /HTTP 404/
    end
    ...
    it 'raises DiscoveryError on invalid JSON' do
      ...
      expect { client.discover(domain) }
        .to raise_error NodeInfo::DiscoveryError, /Invalid JSON/
    end
    ...
    it 'raises DiscoveryError when no links found' do
      ...
      expect { client.discover(domain) }
        .to raise_error NodeInfo::DiscoveryError, /No links found/
    end
    ...
    it 'raises DiscoveryError when no supported schema found' do
      ...
      expect { client.discover domain }
        .to raise_error NodeInfo::DiscoveryError, /No supported NodeInfo schema/
    end
  end
  ...
  describe '#fetch_document' do
    ...
    it 'raises FetchError on HTTP error' do
      ...
      expect { client.fetch_document(nodeinfo_url) }
        .to raise_error NodeInfo::FetchError, /HTTP 500/
    end
  ...
  describe '#fetch' do
    ...
    it 'propagates discovery errors' do
      ...
      expect { client.fetch(domain) }
        .to raise_error NodeInfo::DiscoveryError
    end
    ...
    it 'propagates fetch errors' do
      ...
      expect { client.fetch domain }
        .to raise_error NodeInfo::FetchError
    end
  end
