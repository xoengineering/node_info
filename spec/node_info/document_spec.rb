...
RSpec.describe NodeInfo::Document do
  ...
  describe '.parse' do
    ...
    it 'raises ParseError for invalid JSON' do
      expect { described_class.parse('invalid json') }
        .to raise_error NodeInfo::ParseError
    end
  ...
  describe '#initialize' do
    it 'creates a valid document' do
      software = NodeInfo::Document::Software.new name: 'test', version: '1.0.0'

      doc = described_class.new software: software, protocols: ['activitypub']
    ...
    it 'validates required fields' do
      expect { described_class.new software: nil, protocols: [] }
        .to raise_error NodeInfo::ValidationError, /software is required/
    end

    it 'validates software.name' do
      software = NodeInfo::Document::Software.new name: '', version: '1.0'

      expect { described_class.new software: software, protocols: [] }
        .to raise_error NodeInfo::ValidationError, /software.name is required/
    end

    it 'validates protocols is an array' do
      software = NodeInfo::Document::Software.new name: 'test', version: '1.0'

      expect { described_class.new software: software, protocols: 'activitypub' }
        .to raise_error NodeInfo::ValidationError, /protocols must be an array/
    end

    it 'validates openRegistrations is a boolean' do
      software = NodeInfo::Document::Software.new name: 'test', version: '1.0'

      expect { described_class.new software: software, protocols: [], open_registrations: 'yes' }
        .to raise_error NodeInfo::ValidationError, /openRegistrations must be a boolean/
    end
  end
  ...
  describe NodeInfo::Document::Software do
    ...
    it 'creates software info with all fields' do
      software = described_class.new name:       'test',
                                     version:    '1.0.0',
  ...
  describe NodeInfo::Document::Services do
    ...
    it 'creates services with values' do
      services = described_class.new inbound:  ['atom1.0'],
  ...
  describe NodeInfo::Document::Usage do
    ...
    it 'creates usage with values' do
      usage = described_class.new users:          { total: 100, activeMonth: 50 },
                                  local_posts:    1000,
                                  local_comments: 500
